...
DEFINE_string(graph_path, "/tmp/frozen_model.pb", "Path to the graph protobuf file");
DEFINE_string(target_node, "logits", "Node in the graph to execute");

/**
 * This Module aim to demonstrate how to load the statistic model generated by 
 * the python module and execute it
 **/
int main() {
    tensorflow::Scope root = tensorflow::Scope::NewRootScope();

    // Load the graph into the scope  
    computation::utils::LoadGraphFromFile(root, FLAGS_graph_path);
    ...
    tensorflow::Output output = computation::utils::GenerateOutputFromNode(root.graph(), FLAGS_target_node);
